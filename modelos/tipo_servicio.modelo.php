...
class ModeloTipoServicio {
    ...
    static public function mdlMostrarTipoServicio($tabla, $item, $valor) {
    ...
    static public function mdlCrearTipoServicio($tabla, $datos) {
        $stmt = Conexion::conectar()->prepare(
            "INSERT INTO $tabla (nombre, precio, activo) 
    ...
    static public function mdlEliminarTipoServicio($tabla, $id) {
        $stmt = Conexion::conectar()->prepare(
            "UPDATE $tabla SET activo = 0 WHERE id_tipo_servicio = :id"
        );
